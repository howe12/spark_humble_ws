...
# 初始化函数，包括加载模型和创建订阅者
    def __init__(self):
        ...
        self.image_sub = self.create_subscription(Image, 'input_image', self.detect, 10)
    ...
    def detect(self, msg):
        ...
        cv2.putText(annotated_frame, f'FPS: {int(fps)}', (20,50), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2, cv2.LINE_AA)
        # 设置显示窗口的名称和大小
