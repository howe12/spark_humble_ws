...
def generate_launch_description():
    ...
    spark_slam_transfer_dir = get_package_share_directory('spark_slam_transfer')
    ...
    declared_arguments.append(DeclareLaunchArgument(
        'slam_params_file', 
        default_value=os.path.join(get_package_share_directory("spark_slam_transfer"),
    ...
    spark_delay_slam_action = TimerAction(period=1.0, actions=[start_async_slam_toolbox_node])
