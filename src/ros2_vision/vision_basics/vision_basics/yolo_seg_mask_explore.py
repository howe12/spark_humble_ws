...
cv2.namedWindow('Mask Data Explorer — press any key', cv2.WINDOW_NORMAL)
cv2.resizeWindow('Mask Data Explorer — press any key', 900, 600)
cv2.imshow('Mask Data Explorer — press any key', grid)
cv2.waitKey(0)
cv2.destroyAllWindows()
